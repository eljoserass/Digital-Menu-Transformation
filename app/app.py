...
def _tab_button(
    ...
    return rx.el.button(
        ...
        class_name=rx.cond(
            ...
            "px-4 py-2 text-sm font-semibold text-gray-300 hover:bg-gray-700 rounded-md",
        ),
    )
...
def menu_page() -> rx.Component:
    ...
    return rx.el.main(
        rx.el.header(
            rx.el.div(
                ...
                rx.el.div(
                    ...
                    class_name="flex items-center gap-2 p-1 bg-gray-800 rounded-lg mx-auto",
                ),
                rx.el.div(class_name="w-10 flex justify-end"),
                class_name="flex items-center justify-between w-full max-w-5xl mx-auto",
            ),
            class_name="bg-gray-900 shadow-md p-4 w-full border-b border-gray-700",
        ),
        rx.match(
        ...
        class_name="font-['Roboto'] bg-black min-h-screen text-gray-300",
    )
